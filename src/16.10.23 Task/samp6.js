  ...
  function handleSubmit() {
    setLastSelector((prev) => {
      return prev.map((item) => {
         ...
         if(item?.selected_metrics!=="WEB" && item?.selected_metrics!=="OMS") {
        return {
          ...item,
          meta: {
            ...item.meta,
    ...
    <Box>
      <TableContainer component={Paper}>
        <Table>
          <TableHead>
            <TableRow sx={{backgroundColor:'#e1f5fe',}}>
              <TableCell sx={{fontWeight:800,color:'#2196f3'}}>Private Ip</TableCell>
              <TableCell sx={{fontWeight:800,color:'#2196f3'}}>Exchange</TableCell>
              <TableCell sx={{fontWeight:800,color:'#2196f3'}}>Instance Type</TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
            {last.slice(page * rowsPerPage, (page + 1) * rowsPerPage).map((item,i) => (
              <TableRow   sx={
                i % 2
                  ? { backgroundColor: "#e1f5fe" }
                  : { backgroundColor: " white" }
